...
// Copyright 2024 k2 <skrik2@outlook.com>
//
...
func init() {
	uni.RegisterModule(AppendEncoder{})
}
...
func (AppendEncoder) UniModule() uni.ModuleInfo {
	return uni.ModuleInfo{
		ID:  "logging.encoders.append",
		New: func() uni.Module { return new(AppendEncoder) },
	}
}

// Provision sets up the encoder.
func (fe *AppendEncoder) Provision(ctx uni.Context) error {
	fe.ctx = ctx
	fe.repl = uni.NewReplacer()
...
// SetWriterDefaultFormat will set the default format to "console"
...
func (fe *AppendEncoder) SetWriterDefaultFormat(wp uni.WriterProvider) error {
...
func (fe *AppendEncoder) UnmarshalCaddyfile() error {
...
var (
	...
	_ DelegateSetDefaultFormatForWriter = (*AppendEncoder)(nil)
